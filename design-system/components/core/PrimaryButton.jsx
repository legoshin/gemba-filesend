...
// figma node: 5428:2426 Primary button (4 variants)
const __venc = (v) => String(v).replace(/[%|=]/g, encodeURIComponent);
const __vkey = (p) => "style2=" + __venc(p.style2);

export function PrimaryButton(_p = {}) {
  const props = { ..._p, buttonLabel: _p.buttonLabel ?? "Button", style2: _p.style2 ?? "default", showSuffix: _p.showSuffix ?? true, showLabel: _p.showLabel ?? true, showPrefix: _p.showPrefix ?? true };
  const __body0 = () => (
