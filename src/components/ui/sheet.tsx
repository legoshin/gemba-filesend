          ...
          ? [
              ...
              >
                ...
                >
                  {children}
                  {showCloseButton && (
                    <SheetPrimitive.Close className="data-[state=open]:bg-secondary absolute top-4 right-4 rounded-xs opacity-70 outline-none transition-opacity before:absolute before:-inset-[14px] before:content-[''] hover:opacity-100 focus-visible:shadow-[var(--ring-focus)] disabled:pointer-events-none">
