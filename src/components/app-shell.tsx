...
export function AppShell({ children }: AppShellProps) {
  ...
  const { isEmbed, backgroundColor } = useEmbed();
  const embedStyle = backgroundColor ? { backgroundColor } : undefined;

  return (
    <div className="flex min-h-screen flex-col" style={embedStyle}>
      {!isEmbed && (
      ...
      <main
        className="flex-1 bg-[var(--surface-page)] pb-16 md:pb-0"
        style={embedStyle}
      >
        {children}
      </main>
