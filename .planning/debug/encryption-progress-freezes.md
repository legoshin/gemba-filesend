...
- next_action: awaiting human verification in a real browser (upload progress bar during encryption + the encryption-failure/unencrypted-fallback dialog) before archiving the session
